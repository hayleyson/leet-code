...
public:
    ...
    //     ListNode* n=NULL;
    //     // since slow ptr moves one by one & fast ptr moves by two steps,
    //     // when fast or fast-> next reaches the end, the middle node is around where slow ptr is.
